function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      $(".utterance1").html("\“那个" + stim.Noun + this.verbs[0] + stim.Predicate + "的。\”");

      $(".utterance2").html("\“你错了，那个"+ stim.Noun + this.verbs[1] + stim.Predicate + "的。\”");
...
//    },
    log_responses : function() {
        exp.data_trials.push({
          ...
          "noun" : this.stim.EnglishNoun,          
          "predicate" : this.stim.EnglishPredicate,
